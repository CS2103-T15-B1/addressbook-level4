...
** Highlights: To come up with this command, I had to create a way to generate queries for the retailer to filter his list of customers by age, gender.As such it was
...
* *Code contributed*:
link:..\collated\functional\Sivalavida.md[Functional Code]
link:..\collated\test\Sivalavida.md[Test Code]

* *Other contributions*:
** General team tasks:
*** Added sample data for Person with new attributes which I created.
...
***  User Guide
** Community:
*** PRs reviewed : https://github.com[#27], https://github.com[#34]
