...
* *Major enhancement*: added *Completed product class together with GUI*
...
* *Minor enhancement*: added the GUI element for order class and added Money class to enable working with money.
...
*** resized the customers' list in GUI (Pull requests https://github.com[#33], https://github.com[#34])
