...
* *Major enhancement*: added *the map command*
** What it does: allows user to visualise the spread of selected customers in his list.
...
* *Minor enhancement*: added several attributes to the person model .
