...
image::\images\RecommendEg.jpg[width="600"]

[IMPORTANT]
The model is trained only on a person's _age_ and _gender_. To cap the influence of high volume buyers, multiple purchases of the same product are ignored. +
...
*For v2.0*: Introduce more ML features other than age and gender, and the option to not recommend products a user has already bought.
