...
public class StatusBarFooterHandle extends NodeHandle<Node> {
    ...
    private final StatusBar totalPersonStatusNode;
    ...
    public StatusBarFooterHandle(Node statusBarFooterNode) {
        ...
        this.totalPersonStatusNode = getChildNode(TOTAL_PERSONS_STATUS_ID);
    ...
    public String getTotalPersonsStatus() {
        return totalPersonStatusNode.getText();
    }
    ...
    /**
     * Returns true if the current content of the total persons is different from the value remembered by the most recent
     * {@code rememberSyncStatus()} call.
     */
    public boolean isTotalPersonsStatusChanged() { return !lastRememberedTotalPersonsStatus.equals(getTotalPersonsStatus()); }
