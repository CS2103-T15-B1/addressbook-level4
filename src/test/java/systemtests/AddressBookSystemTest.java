...
public abstract class AddressBookSystemTest {
    ...
    public void setUp() {
        ...
        successStyleOfResultDisplay = mainWindowHandle.getResultDisplay().getStyleClass();
     ...
     */
    protected void assertCommandBoxAndResultDisplayShowsSuccessStyle() {
        assertEquals(successStyleOfResultDisplay, getResultDisplay().getStyleClass());
    }
     ...
     * {@code ClockRule#getInjectedClock()}, while the save location and the total person list remains the same.
     */
